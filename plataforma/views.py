...
def pacientes(request):
    if request.method == "GET":
        ...
        # buscando todos pacientes do banco de dados com o mesmo email digitado acima
...
def dados_paciente_listar(request):
    # Se o dado da requesicao for pelo navegador
    if request.method == "GET":
        pacientes = Pacientes.objects.filter(nutri=request.user)
...
def grafico_peso(request, id):
    ...
    data = {'peso': pesos,
            'labels': labels}
    # sempre que estamos trabalhando com uma api
